...
# python check_freq_gap_score.py --dataset cn_novel_5billion
# python check_freq_gap_score.py --dataset en_writing_prompt
...
def main():
    ...
    train_label_path = f'../data/{dataset}/train.label'
    train_data_path = f'../data/{dataset}/train.tgt'
    ...
    sort_char_path = f'../data/{dataset}/sort_char.txt'
    ...
    save_path = f'../result/vis/freq_gap_{dataset}.csv'
    ...
    #
    # save_path = f'../result/vis/method_frequency_diff_subfig_{dataset}.csv'
