...
class ExpRecorderFreqGap:
    ...
    def add_one_repeat_result(self,
        ...
        self.result_df['kept_char_ratio'].append(kept_char_ratio)
        self.result_df['text_origin_len'].append(text_origin_len)
        self.result_df['text_valid_len'].append(text_valid_len)
